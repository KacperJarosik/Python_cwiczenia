...
if __name__ == '__main__':
    ...
    print('Po ', count_random_even_numbers(sum_max),
          'losowaniach suma wyrzuconych wartości tylko liczb parzystych nie jest większa od wartości podanej jako parametr funkcji')
