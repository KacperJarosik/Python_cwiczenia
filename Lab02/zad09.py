...
while gra_dalej=='tak':
    ...
    while wybor == 'tak':
        ...
        print('Twoj ', ilosc_rzutow_kostka, '. lopierwszy rzut kostka to:', oczka_kostki, 'twoj aktualny wynik to: ',aktualny_wynik,'\n')
